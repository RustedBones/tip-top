...
object TiptopService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The tip-top service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the TiptopService.
  */
trait TiptopService extends Service {
  ...
  override final def descriptor = {
    ...
    named("tip-top")
      ...
      .withTopics(
        topic(TiptopService.TOPIC_NAME, greetingsTopic)
